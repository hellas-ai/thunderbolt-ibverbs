...
static bool tbnet_rx_e2e;
module_param_named(rx_e2e, tbnet_rx_e2e, bool, 0444);
MODULE_PARM_DESC(rx_e2e,
		 "Enable E2E on the USB4NET receive ring when e2e is true (default: false)");
