      ...
      mkNixosVmSmoke =
        ...
        pkgs.testers.runNixOSTest {
          ...
          testScript = ''
            ...
            machine.succeed("mkdir /sys/kernel/config/thunderbolt_ibverbs/vm-link")
            machine.succeed("echo native > /sys/kernel/config/thunderbolt_ibverbs/vm-link/backend")
            machine.succeed("echo 10.0.4.2 > /sys/kernel/config/thunderbolt_ibverbs/vm-link/local_src_ipv4")
            machine.succeed("echo 10.0.5.2 > /sys/kernel/config/thunderbolt_ibverbs/vm-link/peer_ipv4")
            machine.succeed("echo '4 1 1 roce-v2 10.0.4.2' > /sys/kernel/config/thunderbolt_ibverbs/vm-link/app_gids")
            machine.succeed("echo 1 > /sys/kernel/config/thunderbolt_ibverbs/vm-link/seal")
            machine.succeed("grep '^sealed$' /sys/kernel/config/thunderbolt_ibverbs/vm-link/state")
            machine.succeed("grep '^4 1 1 roce-v2 10.0.4.2$' /sys/kernel/config/thunderbolt_ibverbs/vm-link/selection")
            machine.succeed("echo 1 > /sys/kernel/config/thunderbolt_ibverbs/vm-link/activate")
            machine.succeed("grep '^active$' /sys/kernel/config/thunderbolt_ibverbs/vm-link/state")
            machine.succeed("grep '^configured_links: 1$' /sys/kernel/debug/thunderbolt_ibverbs/summary")
            machine.succeed("grep '^link 1 name=vm-link backend=native dev=4 port=1 gid=1 gid_type=2 addr=10.0.4.2$' /sys/kernel/debug/thunderbolt_ibverbs/configured_links")
            machine.fail("echo apple > /sys/kernel/config/thunderbolt_ibverbs/vm-link/backend")
            machine.succeed("rmdir /sys/kernel/config/thunderbolt_ibverbs/vm-link")
